---
name: humanizer
description: Use when editing, rewriting, or humanizing prose and markdown docs (READMEs, guides, specs, design docs, release notes) to remove AI-sounding writing patterns — not-X-but-Y contrasts, one-line closers, staged openers, forced triads, dashes everywhere, inflated claims, sales language, stock AI words, bold labels, filler — so text reads like the writer without changing meaning, structure, links, numbers, or facts.
license: MIT
metadata:
  version: "3.0.0"
---
